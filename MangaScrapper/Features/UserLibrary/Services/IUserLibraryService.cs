...
{
    Task<UserLibraryDocument> AddOrUpdateLibraryEntryAsync(Guid userId, Guid mangaId, string mangaTitle, string mangaImageUrl, string status, CancellationToken ct);
